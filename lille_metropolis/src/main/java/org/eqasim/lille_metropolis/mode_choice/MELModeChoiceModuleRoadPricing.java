...
public class MELModeChoiceModuleRoadPricing extends AbstractEqasimExtension {
    ...
    public MELModeChoiceModuleRoadPricing(CommandLine commandLine, PopulationFactory populationFactory) {
